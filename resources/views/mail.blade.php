                           ...
                           <table class="mobile-hide" style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                              ...
                              <tr>
                                 ...
                                 <td align="right" style="color: #4baad4; font-size: 18px;" class="mobile-hide">
                                    <div>
                                       <a href="#" style="color: #4baad4; text-decoration: none;">Request a demo</a>
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                                    ...
                                    <center>
                                       <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                          <tr>
                                             ...
                                             <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                <div style="line-height: 24px">
                                                   <strong style="color: #4baad4; font-weight: 700;">Step 1. Create Content:</strong><br>Log into your application and <a href="#">create your first user onboarding experience</a>, tutorial for feature announcement. Code free.
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                <div style="line-height: 24px">
                                                   <strong style="color: #4baad4; font-weight: 700;">Step 2. Install your embed script:</strong><br>Either install it yourself, forward these instructions on to a technical colleague or <a href="#">set up a 10 min call</a> with our Lead Engineer for help.
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td align="left" style="color: #95a5a6; font-size: 15px; font-weight: 500; line-height: 24px;">
                                                <div style="line-height: 24px">
                                                   <strong style="color: #4baad4; font-weight: 700;">Step 4. Publish and measure:</strong><br>Use our own analytics or <a href="#">flip on one of our integrations</a> (Kissmetrics, Mixpanel, Segment, Google Analytics and others).
                                                </div>
                                             </td>
                                          </tr>
                                       </table>
                                                ...
                                                <tr>
                                                   <td>
                                                      <div>
                                                         ...
                                                         <![endif]-->
                                                         <a href="#" style="background-color:#80c97a;border:1px solid #80c97a;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:18px;line-height:44px;text-align:center;text-decoration:none;width:150px;-webkit-text-size-adjust:none;mso-hide:all;">Get started &rarr;</a>
                                                      </div>
                                                   </td>
                                                </tr>
                                             </table>
                                             ...
                                             <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="4baad4">
                                                ...
                                                <td align="center">
                                                   <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" bgcolor="4baad4">
                                                      ...
                                                      <tr>
                                                         <td align="center">
                                                            <a href="#" border="0" style="text-decoration: none !important; font-size: 18px; font-family: arial, sans-serif; border-style:none; color:#fff;" target="_blank">Need help? We have you covered. <em>Request a demo today.</em></a>
                                                         </td>
                                                      </tr>
                                                      </td>
                                                      </tr>
                                    ...
                                    <table cellspacing="0" cellpadding="0" bgcolor="#e8ecf0"  class="force-full-width">
                                       <tr>
                                          <td style="background-color:#e8ecf0; text-align:center;">
                                             <br>
                                             <br>
                                             <a href="#"><img width="30" src="https://s3.amazonaws.com/appcues-email-assets/images/google-icon.png" alt=""></a>
                                             <a href="#"><img width="30" src="https://s3.amazonaws.com/appcues-email-assets/images/facebook-icon.png" alt=""></a>
                                             <a href="#"><img width="30" src="https://s3.amazonaws.com/appcues-email-assets/images/twitter-icon.png" alt=""></a>
                                             <br>
                                             <br>
                                          </td>
                                       </tr>
